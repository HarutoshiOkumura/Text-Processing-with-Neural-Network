...
def vectorize_text(train_docs, test_docs, stop_words="english"):
    """
    Converts raw text documents into a document-term matrix.

    Parameters:
      train_docs (list of str): Training documents.
      test_docs (list of str): Test documents.
      stop_words (str or list): Stop words to filter out.

    Returns:
      X_train, X_test (sparse matrix): The token count matrices.
